...
const Search: React.FunctionComponent<SearchProps> = ({ i18n }) => {
  ...
  return (
    <div className="relative flex lg:justify-center items-center h-20 md:h-48 border-b-2 rr-border w-full">
      <form
      ...
      >
        <input
          className="mr-4 px-2 min-m-lg border-b-2 rr-border dark:bg-slate-800 rr-text w-full"
          type="text"
          name="search"
      ...
      {results && (
        <div className="absolute px-3 bg-slate-100 dark:bg-slate-800 border-2 border-zinc-900 top-16 w-full z-10">
          <ul>
